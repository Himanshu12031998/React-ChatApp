  ...
  return (
    <div className="main-container">
      <div className="container">
            ...
            <h1> HimaChatApp</h1> <br />
				<h2>Hello, Friend!</h2> <br />
				<p>Enter your personal details and start journey with us</p> <br />
				<Link to="/Login"><button className="butto btn"> Sign in</button></Link> <br />
			</div>
          ...
          {err && <span>Something went wrong</span>}
            ...
            <div className="main">
                ...
                <h1 >Register</h1>
                    ...
                    <input type="file" required id="file"  style={{ display: "none" }} className="input"/>
                    <label htmlFor="file" className="label" >
            <img src={Add} alt="" />
            <span>Add an avatar</span>
          </label>
                    <button  className="butto" disabled={loading}> Signup</button>
                </form>
